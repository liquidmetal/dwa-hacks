...
const ::google::protobuf::Descriptor* FishSim_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  FishSim_reflection_ = NULL;

}  // namespace


void protobuf_AssignDesc_fish_2dsim_2eproto() {
  protobuf_AddDesc_fish_2dsim_2eproto();
  ...
  FishSim_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      FishSim_descriptor_,
      FishSim::default_instance_,
      FishSim_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(FishSim, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(FishSim, _unknown_fields_),
      -1,
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_fish_2dsim_2eproto);
}

void protobuf_RegisterTypes(const ::std::string&) {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    FishSim_descriptor_, &FishSim::default_instance());
}

}  // namespace

void protobuf_ShutdownFile_fish_2dsim_2eproto() {
  delete FishSim::default_instance_;
  delete FishSim_reflection_;
}
...
void protobuf_AddDesc_fish_2dsim_2eproto() {
  ...
  FishSim::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_fish_2dsim_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_fish_2dsim_2eproto {
  StaticDescriptorInitializer_fish_2dsim_2eproto() {
    protobuf_AddDesc_fish_2dsim_2eproto();
  }
} static_descriptor_initializer_fish_2dsim_2eproto_;
...
void FishSim::InitAsDefaultInstance() {
}

FishSim::FishSim(const FishSim& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
}
...
void FishSim::SharedDtor() {
  if (this != default_instance_) {
  }
}

void FishSim::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* FishSim::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return FishSim_descriptor_;
}

const FishSim& FishSim::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_fish_2dsim_2eproto();
  return *default_instance_;
}

FishSim* FishSim::default_instance_ = NULL;

FishSim* FishSim::New() const {
  return new FishSim;
}
...
bool FishSim::MergePartialFromCodedStream(
...
void FishSim::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const FishSim* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const FishSim*>(
      &from);
  if (source == NULL) {
...
void FishSim::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void FishSim::CopyFrom(const FishSim& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata FishSim::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = FishSim_descriptor_;
  metadata.reflection = FishSim_reflection_;
  return metadata;
}
